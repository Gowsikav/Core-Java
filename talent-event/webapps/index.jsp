...
<body>
    ...
    <section>
        <p class="h1 text-center pt-3">Welcome to Talent Show Event Management</p>
    </section>

    <footer class="text-dark fixed-bottom p-2" style="background:rgba(219, 112, 231, 0.58) !important;">
