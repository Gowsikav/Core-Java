        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="room-book.jsp">Book Room</a>
                    </li>
                </ul>
        ...
        <div class="col-md-6 col-lg-5">
            <form class="p-3 fs-5" action="book" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="days" name="numberOfDays">
                </div>
                <div class="mb-3">
                    <label for="comingDate" class="form-label">Arrival Date</label>
                    <input type="date" class="form-control" id="comingDate" name="arrivalDate">
                </div>
                <div class="mb-3">
