...
<section>
    <p class="h1 text-center pt-3">Room Booked Successfully</p>
    <div >
        <table class="table table-primary table-hover table-bordered border-dark" style="background:rgb(107 172 215);">
            <thead>
            <tr>
            ...
            <tbody>
            <tr>
                <td>${roomBookingDto.hotelName}</td>
                <td>${roomBookingDto.roomType}</td>
                <td>${roomBookingDto.numberOfDays}</td>
                <td>${roomBookingDto.arrivalDate}</td>
                <td>${roomBookingDto.checkOutDate}</td>
            </tr>
            </tbody>
        </table>
    </div>
