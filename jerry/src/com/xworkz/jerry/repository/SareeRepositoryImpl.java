...
public class SareeRepositoryImpl implements SareeRepository{
    public SareeRepositoryImpl()
    {
        System.out.println("SareeRepository implementation constructor");
    }

    @Override
    public Collection<SareeDto> findAll() {
        System.out.println("findAll method in SareeRepository implementation");
