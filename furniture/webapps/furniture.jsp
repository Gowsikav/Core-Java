  ...
  <body>
   ...
   <main class="container my-4 col-md-4">
         ...
         <div class="mb-3 col-auto">
             ...
             <input type="text" class="form-control" id="model" name="modelName" />
           </div>
           <div class="mb-3 col-auto">
             <label for="productBenefits" class="form-label">Product Benefits</label>
             <textarea id="productBenefits" name="productBenefits" class="form-control"></textarea>
           </div>
           <div class="text-center">
           <input type="submit" class="bg-primary text-white" value="Save Details" />
           </div>
         </form>
       </main>
