    ...
    <main class="container my-4 col-md-6">
      ...
      <form action="license" method="POST">
        ...
        <div class="mb-3 col-auto">
          <label for="name" class="form-label">License Holder</label>
          <input type="text" class="form-control" id="name" name="name" />
        </div>
        <div class="row mb-3 align-items-center">
          <div class="col-md-2">
            <label for="licenseType" class="col-form-label">License Type</label>
          </div>
          <div class="col-md-4">
            <select id="licenseType" class="form-select" name="type">
      ...
      <div class="mb-3 col-auto">
        ...
        <input type="submit" class="bg-success text-white" value="Submit License" />
      </form>
    </main>
